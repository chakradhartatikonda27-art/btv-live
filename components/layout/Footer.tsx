...
export default async function Footer() {
  ...
  const phone = settings?.contactPhone || '+91-9885126368';
    ...
    <footer className="bg-obsidian-900 border-t border-obsidian-700">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 py-16">
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginTop: '24px', marginBottom: '16px' }}>
          <a href="/whatsapp" style={{ width: '36px', height: '36px', borderRadius: '50%', background: '#25D366', display: 'flex', alignItems: 'center', justifyContent: 'center', textDecoration: 'none' }}>
          ...
          <a href="/instagram" style={{ width: '36px', height: '36px', borderRadius: '50%', background: 'linear-gradient(45deg, #f09433, #e6683c, #dc2743, #cc2366, #bc1888)', display: 'flex', alignItems: 'center', justifyContent: 'center', textDecoration: 'none' }}>
          ...
          <a href="/youtube" style={{ width: '36px', height: '36px', borderRadius: '50%', background: '#FF0000', display: 'flex', alignItems: 'center', justifyContent: 'center', textDecoration: 'none' }}>
        ...
        <div className="mt-4 pt-6 border-t border-obsidian-700 flex flex-col md:flex-row items-center justify-between gap-3 md:gap-4">
