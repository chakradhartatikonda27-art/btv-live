    ...
    <section style={{ padding: '60px 20px', position: 'relative', overflow: 'hidden', background: 'linear-gradient(135deg, #080C18 0%, #0D0F12 50%, #08090B 100%)' }}>
      ...
      <div style={{ position: 'relative', maxWidth: '700px', margin: '0 auto', textAlign: 'center' }}>
        <div style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', borderRadius: '999px', padding: '6px 16px', marginBottom: '24px', background: 'rgba(212,168,50,0.05)', border: '1px solid rgba(212,168,50,0.3)' }}>
          <span style={{ color: 'var(--accent-gold)', fontFamily: 'monospace', fontSize: '11px', letterSpacing: '0.2em', textTransform: 'uppercase' }}>Share Your Story</span>
        </div>
        ...
        <div style={{ display: 'flex', gap: '12px', justifyContent: 'center', flexWrap: 'wrap' }}>
          <Link href='/apply' style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', background: 'var(--accent-gold)', color: '#08090B', padding: '14px 28px', borderRadius: '999px', fontWeight: '600', fontSize: '15px', textDecoration: 'none' }}>
            Nominate a Leader
          </Link>
          <Link href='/apply#self' style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', color: 'var(--text-secondary)', border: '1px solid var(--border-color)', padding: '14px 28px', borderRadius: '999px', fontWeight: '500', fontSize: '15px', textDecoration: 'none' }}>
