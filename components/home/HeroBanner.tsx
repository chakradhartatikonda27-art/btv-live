...
export default function HeroBanner({ interview }: { interview?: any }) {
  ...
  return (
    <section style={{ position: 'relative', overflow: 'hidden', display: 'flex', flexDirection: 'column', justifyContent: 'flex-start', zIndex: 1, paddingTop: '40px', paddingBottom: '20px'}}>
      {/* Background */}
      ...
      {/* Content */}
      <div style={{ position: 'relative', zIndex: 10, padding: '16px 16px 16px', maxWidth: '800px' }}>
        {/* Category badge */}
